...
export function crRequest(userid,title,description,category,numOfPeople,duration,budget, workLinks, availableSlots){
    return(dispatch) => {
        //dispatch(posting())
        ...
        NetInfo.isConnected.fetch().done((isConnected) => {
            if(isConnected){
                createRequest(userid,title,description,category,numOfPeople,duration,budget, workLinks, availableSlots).then(res => {
