...
export function upRequest(requestid,title,description,category,numOfPeople,duration,budget, workLinks){
    return(dispatch) => {
        //dispatch(posting())
        ...
        NetInfo.isConnected.fetch().done((isConnected) => {
            if(isConnected){
                updateRequest(requestid,title,description,category,numOfPeople,duration,budget, workLinks).then(res => {
